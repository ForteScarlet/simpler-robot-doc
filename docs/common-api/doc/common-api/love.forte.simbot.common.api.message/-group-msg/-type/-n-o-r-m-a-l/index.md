//[common-api](../../../../index.md)/[love.forte.simbot.common.api.message](../../../index.md)/[GroupMsg](../../index.md)/[Type](../index.md)/[NORMAL](index.md)
...
| [compareTo](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/compare-to.html)| [JVM]  <br>Content  <br>operator override fun [compareTo](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-enum/compare-to.html)(other: [GroupMsg.Type](../index.md)): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)  <br><br><br>
...
|  Name|  Summary| 
|---|---|
| [name](index.md#love.forte.simbot.common.api.message/GroupMsg.Type.NORMAL/name/#/PointingToDeclaration/)|  [JVM] override val [name](index.md#love.forte.simbot.common.api.message/GroupMsg.Type.NORMAL/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#love.forte.simbot.common.api.message/GroupMsg.Type.NORMAL/ordinal/#/PointingToDeclaration/)|  [JVM] override val [ordinal](index.md#love.forte.simbot.common.api.message/GroupMsg.Type.NORMAL/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
